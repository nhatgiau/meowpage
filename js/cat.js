...
gsap_1.gsap.set(music.note, { scale: 0, autoAlpha: 1 });
var animatePawState = function (selector) {
    return gsap_1.gsap.fromTo(selector, { autoAlpha: 0 }, {
        autoAlpha: 1,
        duration: 0.01,
        repeatDelay: 0.19,
        yoyo: true,
...
tl.add(animatePawState(cat.pawLeft.up), "start")
    ...
    .timeScale(1.6);
gsap_1.gsap.from(".terminal-code line", {
    drawSVG: "0%",
    duration: 0.1,
    stagger: 0.1,
    ease: "none",
...
var noteElFn = gsap_1.gsap.utils.pipe(gsap_1.gsap.utils.toArray, gsap_1.gsap.utils.shuffle);
...
var notesG3 = noteEls;
var colorizer = gsap_1.gsap.utils.random([green, pink, blue, orange, cyan, "#a3a4ec", "#67b5c0", "#fd7c6e"], true);
var rotator = gsap_1.gsap.utils.random(-50, 50, 1, true);
var dir = function (amt) { return "".concat(gsap_1.gsap.utils.random(["-", "+"]), "=").concat(amt); };
var animateNotes = function (els) {
    els.forEach(function (el) {
        gsap_1.gsap.set(el, {
            stroke: colorizer(),
            rotation: rotator(),
            x: gsap_1.gsap.utils.random(-25, 25, 1),
        });
    });
    gsap_1.gsap.fromTo(els, {
        autoAlpha: 1,
        y: 0,
        scale: 0,
    }, {
        ...
        rotation: dir(gsap_1.gsap.utils.random(20, 30, 1)),
        x: dir(gsap_1.gsap.utils.random(40, 60, 1)),
        y: gsap_1.gsap.utils.random(-200, -220, 1),
        onComplete: function () {
            animateNotes(els);
        },
    });
};
tl.add(function () { return animateNotes(notesG1); }).add(function () { return animateNotes(notesG2); }, ">0.05").add(function () { return animateNotes(notesG3); }, ">0.25");
